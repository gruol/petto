...
<body>
  ...
  <div style="width: 600px; background: #f2f2f2; margin: 0 auto; font-family: Arial, Helvetica, sans-serif; ">
   ...
   <div style="font-size: 15px; padding: 15px;">
    ...
    <p>A customer has booked a shipment based on your response to their query. Please review the booking details and proceed with the necessary arrangements using your portal.</p>
