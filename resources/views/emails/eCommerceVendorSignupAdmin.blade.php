...
<body>
  ...
  <div style="width: 600px; background: #f2f2f2; margin: 0 auto; font-family: Arial, Helvetica, sans-serif; ">
   ...
   <div style="font-size: 15px; padding: 15px;">
    ...
    <p>A new eCommerce vendor has signed up for the Petto app. Please review their details and approve their account using your web portal.</p>
    <p><b>User Details:</b></p>
    <p>Name: {{ $details['vendor_name'] }}</p>
    <p>Email: {{ $details['email'] }}</p>
    <p>Contact #: {{ $details['contact'] }}</p>
    <p>Business Name: {{ $details['clinic_name'] }}</p>
    <br>
