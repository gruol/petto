...
<body>
  ...
  <div style="width: 600px; background: #f2f2f2; margin: 0 auto; font-family: Arial, Helvetica, sans-serif; ">
   ...
   <div style="font-size: 15px; padding: 15px;">
    ...
    <p>Thank you for registering your clinic with Petto. Your application is currently under review by
    our team. We will notify you once the review process is complete.</p>
