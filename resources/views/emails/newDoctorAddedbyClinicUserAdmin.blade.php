...
<body>
  ...
  <div style="width: 600px; background: #f2f2f2; margin: 0 auto; font-family: Arial, Helvetica, sans-serif; ">
   ...
   <div style="font-size: 15px; padding: 15px;">
    <h4 style="color: #61301f;">Dear Petto Admin,</h4>
    <p>A new doctor has been added by a clinic user. Please review the details and approve the doctor's profile using your web portal.</p>
    <p><b>Doctor Details:</b></p>
    <p>Name: {{ $details['name'] }}</p>
    <p>Email: {{ $details['email'] }}</p>
    <p>Contact #: {{ $details['contact_no'] }}</p>
    <p>Specialization: {{ $details['specialization'] }}</p>
    <p>Clinic Name: {{ $details['clinic_name'] }}</p>
    <br>
