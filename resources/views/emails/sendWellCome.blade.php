...
<body>
  ...
  <div style="width: 600px; background: #f2f2f2; margin: 0 auto; font-family: Arial, Helvetica, sans-serif; ">
   ...
   <div style="font-size: 15px; padding: 15px;">
    ...
    <p>We are excited to inform you that your registration with Petto has been successfully completed.
      You can now explore our app and take advantage of all the features we offer for your beloved
    pet.</p>
